...
akshay_image = face_recognition.load_image_file("known_faces/myphoto.jpg")
akshay_face_encoding = face_recognition.face_encodings(akshay_image)[0]

friend_image = face_recognition.load_image_file("known_faces/friend.jpg")
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            if matches[best_match_index]:
                ...
                send_sms("Unkown face detected in your room ")
